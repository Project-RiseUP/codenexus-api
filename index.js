...
const server = app.listen(PORT, () => {
  ...
  console.log('\x1b[36m%s\x1b[0m', '║                                                        ║');
  console.log('\x1b[36m%s\x1b[0m', '║      🔗  CodeNexus API - Connection Hub  🔗            ║');
  console.log('\x1b[36m%s\x1b[0m', '║                                                        ║');
  console.log('\x1b[36m%s\x1b[0m', '╚════════════════════════════════════════════════════════╝');
  console.log();
  ...
  console.log();
  console.log('\x1b[36m%s\x1b[0m', '📚 Visit http://localhost:' + PORT + ' for full documentation');
  console.log();
